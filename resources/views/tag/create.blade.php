                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/tag" method="post">
                            ...
                            <br/><div style="font-size: 130%;" class="mr-2 badge badge-primary">primary</div><div style="font-size: 130%;" class="mr-2 badge badge-secondary">secondary</div><br/><br/>
                            <div class="form-group">
                                <label for="style">Style</label>
                                <textarea class="form-control {{ $errors->has('style')? 'border-danger':'' }}"placeholder="primary or secondary" id="style" name="style" rows="5">{{ old('style') }}</textarea>
